...
#ifndef ROBOT_INTERFACES__SRV__DETAIL__LM_CHAT__FUNCTIONS_H_
#define ROBOT_INTERFACES__SRV__DETAIL__LM_CHAT__FUNCTIONS_H_
...
/// Create srv/LMChat message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_interfaces__srv__LMChat_Request__init().
...
/// Destroy srv/LMChat message.
/**
 * It calls
 * robot_interfaces__srv__LMChat_Request__fini()
...
/// Check for srv/LMChat message equality.
/**
...
/// Initialize array of srv/LMChat messages.
/**
...
/// Finalize array of srv/LMChat messages.
/**
 * It calls
 * robot_interfaces__srv__LMChat_Request__fini()
...
/// Create array of srv/LMChat messages.
/**
 * It allocates the memory for the array and calls
 * robot_interfaces__srv__LMChat_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/LMChat messages.
/**
 * It calls
 * robot_interfaces__srv__LMChat_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/LMChat message array equality.
/**
...
/// Copy an array of srv/LMChat messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_interfaces__srv__LMChat_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_interfaces
...
/**
 * It calls
 * robot_interfaces__srv__LMChat_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_interfaces
...
/**
 * It allocates the memory for the array and calls
 * robot_interfaces__srv__LMChat_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_interfaces
...
/**
 * It calls
 * robot_interfaces__srv__LMChat_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOT_INTERFACES__SRV__DETAIL__LM_CHAT__FUNCTIONS_H_
